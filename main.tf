...
locals {
  ...
  pytorch_image_tag = {
    ...
    "2.3.0-cpu"  = "2.3.0-transformers${var.transformers_version}-cpu-py311-ubuntu22.04"
    "2.3.0-gpu"  = "2.3.0-transformers${var.transformers_version}-gpu-py311-cu121-ubuntu22.04"
  }
